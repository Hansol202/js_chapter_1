...
const yuJin = new IdolModel('안쥬진', 2003);
...
IdolModel3.sayStatcHello = function(){
    return '안녕하세요 저는 static method 입니다.';
}

console.log(IdolModel3.sayStatcHello());
 ...
 * 
 * 인스턴스의 --proto__ 변경 vs 함수의 prototype 변경
 */
function IdolModel(name, year){
    this.name = name;
    this.year = year;
...
IdolModel.prototype.sayHeloo = function(){
